<div class="navbar-custom topnav-navbar topnav-navbar-light">
    <div class="container-fluid">
        ...
        <!-- LOGO -->
        <a href="{{ route('home') }}" class="topnav-logo logo-light">
            <span class="topnav-logo-lg">
                {{-- <img src="assets/images/logo-light.png" alt="" height="16"> --}}
                <span><img src="{{ asset('logo.png') }}" alt="" height="40"></span>
            </span>
            <span class="topnav-logo-sm">
                <span><img src="{{ asset('favicon.png') }}" alt="" height="40"></span>
                {{-- <img src="assets/images/logo_sm.png" alt="" height="16"> --}}
            </span>
        </a>
        <a href="{{ route('home') }}" class="topnav-logo logo-dark">
            <span class="topnav-logo-lg">
                {{-- <img src="assets/images/logo-light.png" alt="" height="16"> --}}
                <span><img src="{{ asset('logo-dark.png') }}" alt="" height="40"></span>
            </span>
            <span class="topnav-logo-sm">
                {{-- <span><img src="{{ asset('favicon-dark.png') }}" alt="" height="40"></span> --}}
                <span><img src="{{ asset('favicon-dark.png') }}" alt="" height="40"></span>
                {{-- <img src="assets/images/logo_sm.png" alt="" height="16"> --}}
            </span>
        </a>
