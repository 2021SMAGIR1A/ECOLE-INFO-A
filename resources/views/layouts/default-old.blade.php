...
<head>
    ...
    <body class="loading" data-layout="detached" data-layout-config='{"leftSidebarCondensed":true,"darkMode":false, "showRightSidebarOnStart": false'>
            ...
            <div class="container-fluid">
                ...
                <a href="{{ route('home') }}" class="topnav-logo logo-dark">
                    <span class="topnav-logo-lg">
                        ...
                        <span><img src="{{ asset('logo.png') }}" alt="" height="30"></span>
                    </span>
                    <span class="topnav-logo-sm">
                        <span><img src="{{ asset('favicon.png') }}" alt="" height="30"></span>
