...
<div class="modal fade" id="createComplaintModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-main-primary">
                <h4 class="modal-title text-uppercase" id="exampleModalLabel"><i class="fas fa-file"></i> AJOUT D'UNE Reclamation</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="text-danger" id="closeModal">&times;</span>
                </button>
            </div>
            <form class="modal-body" role="form" method="POST" action="{{ route('ComplaintPostCreate') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <label for="marks_id"> <strong>Marks_id</strong><span marks_id="Requis" style="color: #DE3246">(*)</span></label>
                    <input id="marks_id" type="text" class="form-control{{ $errors->has('marks_id') ? ' has-error' : '' }}" required
                            name="marks_id"
