...
<div class="modal fade modal-edit" id="editComplaintModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="modal-body" role="form" method="POST" action="#" id="form_edit">
                ...
                <div class="form-group">
                        <label for="marks_id_edit"> <strong></strong><span marks_id="Requis" style="color: #DE3246">(*)</span></label>
