...
<div class="modal fade modal-edit" id="editTeacherModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="modal-body" role="form" method="POST" action="#" id="form_edit">
                ...
                <div class="form-group">
                        <label for="nom_edit"> <strong></strong><span nom="Requis" style="color: #DE3246">(*)</span></label>
                        <input id="nom_edit" type="text" class="form-control{{ $errors->has('nom') ? ' has-error' : '' }}" required
                                name="nom"
                                placeholder="Entrez le "
                                value="{{ old('nom') }}">
                        @if ($errors->has('nom'))
                ...
                <div class="form-group">
                        <label for="prenoms_edit"> <strong></strong><span prenoms="Requis" style="color: #DE3246">(*)</span></label>
                        <input id="prenoms_edit" type="text" class="form-control{{ $errors->has('prenoms') ? ' has-error' : '' }}" required
                                name="prenoms"
                                placeholder="Entrez le "
                                value="{{ old('prenoms') }}">
