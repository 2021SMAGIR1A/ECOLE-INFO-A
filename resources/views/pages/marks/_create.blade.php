...
<div class="modal fade" id="createMarkModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="modal-body" role="form" method="POST" action="{{ route('Module-TaskManagerMarkPostCreate') }}">
                {{ csrf_field() }}
                <div class="form-group">
                        <label for="mark"> <strong></strong><span mark="Requis" style="color: #DE3246">(*)</span></label>
                ...
                <div class="form-group">
                        <label for="observations"> <strong></strong></label>
                ...
                <div class="form-group">
                        <label for="tests_id"> <strong></strong><span tests_id="Requis" style="color: #DE3246">(*)</span></label>
                ...
                <div class="form-group">
                        <label for="students_id"> <strong></strong><span students_id="Requis" style="color: #DE3246">(*)</span></label>
