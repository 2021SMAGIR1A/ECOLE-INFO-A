...
<div class="modal fade modal-edit" id="editTestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="modal-body" role="form" method="POST" action="#" id="form_edit">
                ...
                <div class="form-group">
                        <label for="coef_edit"> <strong></strong><span coef="Requis" style="color: #DE3246">(*)</span></label>
                ...
                <div class="form-group">
                        <label for="datetest_edit"> <strong></strong></label>
                ...
                <div class="form-group">
                        <label for="courses_id_edit"> <strong></strong><span courses_id="Requis" style="color: #DE3246">(*)</span></label>
