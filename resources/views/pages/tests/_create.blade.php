...
<div class="modal fade" id="createTestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="modal-body" role="form" method="POST" action="{{ route('Module-TaskManagerTestPostCreate') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                        <label for="coef"> <strong></strong><span coef="Requis" style="color: #DE3246">(*)</span></label>
                ...
                <div class="form-group">
                        <label for="datetest"> <strong></strong></label>
                ...
                <div class="form-group">
                        <label for="courses_id"> <strong></strong><span courses_id="Requis" style="color: #DE3246">(*)</span></label>
