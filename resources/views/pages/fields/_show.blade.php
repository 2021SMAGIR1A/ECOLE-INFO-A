...
<div class="modal fade modal-show" id="showField{{ $field->uuid }}Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-main-primary">
                <h4 class="modal-title text-uppercase" id="exampleModalLabel"><i class="fas fa-file"></i> AFFICHAGE D'UNE Filière</h4>
            ...
            <div class="modal-body" id="form_show">
                <div class="form-group">
                        ...
                        <input id="title_show" type="text" class="form-control" required
                                ...
                                value="{{ $field->title }}" readonly="readonly">
                    </div>
                <div class="form-group">
                        ...
                        <textarea id="description_show" class="form-control"
                              name="description"
                              rows="5"
                              placeholder="Entrez la description" readonly="readonly">{{ $field->description }}</textarea>
                    </div>
