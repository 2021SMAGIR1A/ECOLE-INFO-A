...
<div class="modal fade" id="createClasseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="modal-body" role="form" method="POST" action="{{ route('Module-TaskManagerClassePostCreate') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                        <label for="fields_id"> <strong></strong><span fields_id="Requis" style="color: #DE3246">(*)</span></label>
