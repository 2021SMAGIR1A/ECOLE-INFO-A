...
{    
    ...
    static function store(array $values)
    {
        ...
        return ($create ? ['status' => true, 'message' => 'Ajout de Classe effectué avec succès !', 'data' => self::find($create)] :
            ['status' => false, 'message' => 'Ajout de Classe Impossible !']);
    ...
    function uptodate(array $values)
    {
        ...
        return ($create ? ['status' => true, 'message' => 'Mise à jour de Classe effectuée avec succès !', 'data' => self::find($create)] :
            ['status' => false, 'message' => 'Mise à jour de Classe Impossible !']);
