        ...
        (t.prototype._selectOptionsFromConfig = function () {
            ...
            if (t) {
                ...
                t.isBoxed
                    ...
                    t.isDarkModeEnabled ||
                        ...
                        "vertical" === t.layout &&
                            a("input[type=radio][name=theme]").prop(
                                "disabled",
                                !1
                            )),
                    t.isDarkModeEnabled &&
            ...
            (t.prototype.init = function () {
                ...
                a(document).on("click", ".right-bar-toggle", function () {
                    ...
                    a("input[type=radio][name=color-scheme-mode]").change(
                        function () {
                            switch (a(this).val()) {
                                case "light":
